    ...
    <div className='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
      <div className='col-span-3'>
        ...
        <div className='space-y-8'>
          ...
          <p>
            Our {cabins.length} luxury cabins provide a cozy base, but
      ...
      <div className='relative col-span-2 aspect-square'>
        <Image
          ...
          // placeholder='blur' // we can do this only for statically imported images (preloaded images)
          //* This is because Next.js needs to generate the blur-up placeholder at build time, which is only possible with statically imported images.
        />
      </div>
      ...
      <div className='col-span-3'>
        ...
        <div className='space-y-8'>
          <p>
            ...
            nurtured with love and care, passing down through our
            family as a testament to our dedication to creating a
            warm, welcoming environment.
          </p>
          <p>
            Over the years, we&apos;ve maintained the essence of The
            Wild Oasis, blending the timeless beauty of the mountains
            with the personal touch only a family business can offer.
            Here, you&apos;re not just a guest; you&apos;re part of
            our extended family. So join us at The Wild Oasis soon,
            where tradition meets tranquility, and every visit is like
            coming home.
          </p>
